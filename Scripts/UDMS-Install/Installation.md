...
>* UDMS
>
> Note: The Docker compose files and the docker volumes are stored in the "UDMS" folder (SO DONT DELETE IT, unless you know what you are doing). The "UDMS-install" folder is the main folder for the script.
...
```
bash <(wget -qO- https://raw.githubusercontent.com/GertGerber/UDMS/Prod/Script/UDMS-Install/Download.sh)
```
